		        ...
		        <div class="d-md-flex justify-content-between pd-25">
		        	<div class="bd bd-gray-300 rounded table-responsive">
								...
								<tr>
									...
									<td>
										<div class="action_bar">
											<a href="{{ route('curriculum.edit', $curriculum->id) }}"><i class="fas fa-edit"></i></a>
											<a href="" data-toggle="modal" data-target="#delete{{ $curriculum->id }}"><i class="fas fa-trash"></i></a>
										</div>
								<!-- Modal -->
								<div class="modal fade" id="delete{{ $curriculum->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						...
						@if( $curriculums->count() == 0 )
							<div class="alert alert-info">No CourseCurriculum Added Yet.</div>
						@endif
						<!-- manage part end -->
					</div>
		        </div>
