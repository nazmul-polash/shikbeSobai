    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <span>
                    <img style="width: 100px;margin-top: 10px;margin-bottom: 10px;" src="{{ URL::to('frontend/assets/images/Shikhbe-shobai-logo.png')}}" alt="">
                </span>
            </a>
            ...
            <div class="navbar-collapse justify-content-center" id="sidebar">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link section-scroll" href="{{ route('course') }}">Courses</a>
                    </li>
                    <li class="nav-item">
