		    ...
		    <section id="home" class="pd-tp-80 hero">
		        <div class="container">
		            <div class="row">
		                ...
		                <div class="img-right">
		                    <img src="{{ URL::to('frontend/assets/images/intro.png')}}" alt="">
		                </div>
		            </div>
		        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7 col-12">
                            <div class="box-img-left">
                                ...
                                <img src="{{ URL::to('frontend/assets/images/image2.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="services" class="bg-color ">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7  col-12">
                            <img src="{{ URL::to('frontend/assets/images/Support.png')}}" alt="">
            ...
            <section id="services" class="bg-color-2">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7  col-12">
                            <img src="{{ URL::to('frontend/assets/images/image3.png')}}" alt="">
            ...
            <section id="services" class="bg-color ">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7  col-12">
                            <img src="{{ URL::to('frontend/assets/images/Card-Mockup.png')}}" alt="" class="img-fluid" style="width: 80%; display: block; margin: 50px auto 0;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel"> <img src="{{ URL::to('frontend/assets/images/tab-1.png')}}" alt=""></div>
                                <div class="tab-pane fade" id="nav-profile" role="tabpanel"><img src="{{ URL::to('frontend/assets/images/tab-2.png')}}" alt=""></div>
                                <div class="tab-pane fade" id="nav-contact" role="tabpanel"><img src="{{ URL::to('frontend/assets/images/tab-3.png')}}" alt=""></div>
                                <div class="tab-pane fade" id="nav-contact-1" role="tabpanel"><img src="{{ URL::to('frontend/assets/images/tab-4.png')}}" alt=""></div>
                            </div>
                            <nav>
            ...
            <section id="video" class= " clearfix">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-video">
                                <img src="{{ URL::to('frontend/assets/images/lab.jpg')}}" class="box-video-img" alt="">

                                <div class="box-video-btn">
                                    <a href="https://www.youtube.com/embed/uLDvdlW9VEY" class="video-modal"> <img src="{{ URL::to('frontend/assets/images/play.svg')}}" alt=""></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class=" col-md-4 col-12">
                                <div class="text-quote">
                                    ...
                                    <img src="{{ URL::to('frontend/assets/images/quote.png')}}" alt="">
                                ...
                                <div class="slider-avatar">
                                    ...
                                    <div data-slide="1" class="item-image avatar1 medium-avtar">
                                        <img src="{{ URL::to('frontend/assets/images/testimonial/imran-small.jpg')}}">
                                    </div>
                                    <div data-slide="2" class="item-image avatar2 medium-avtar">
                                        <img src="{{ URL::to('frontend/assets/images/testimonial/sabiha-small.png')}}">
                                    </div>
                                    <div data-slide="3" class="item-image avatar3 medium-avtar">
                                        <img src="{{ URL::to('frontend/assets/images/testimonial/alif-small.jpg')}}">
                                    </div>
                                ...
                                <div class="testimonial-slider">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="avatar-item">
                                            ...
                                            <img src="{{ URL::to('frontend/assets/images/testimonial/imran.jpg')}}" alt="">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="avatar-item">
                                            ...
                                            <img src="{{ URL::to('frontend/assets/images/testimonial/sabiha.jpg')}}" alt="">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="avatar-item">
                                            ...
                                            <img src="{{ URL::to('frontend/assets/images/testimonial/alif.jpg')}}" alt="">
