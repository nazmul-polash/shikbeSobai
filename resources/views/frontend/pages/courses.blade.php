                        ...
                        <div class="tab-pane fade show active" id="allCourses" role="tabpanel" aria-labelledby="allCourses-tab">
                            ...
                            <div class="course-slider">
                                <div class="owl-carousel owl-theme">
                                    <div class="item">
                                        <img src="{{ URL::to('frontend/assets/images/icons/icon-1.png')}}">
                                        <h4>Graphic Design</h4>
                                    </div>

                                    <div class="item">
                                        <img src="{{ URL::to('frontend/assets/images/icons/icon-2.png')}}">
                                        <h4>Web Design</h4>
                                    </div>

                                    <div class="item">
                                        <img src="{{ URL::to('frontend/assets/images/icons/icon-3.png')}}">
                                        <h4>Digital Design</h4>
                                    </div>

                                    <div class="item">
                                        <img src="{{ URL::to('frontend/assets/images/icons/icon-4.png')}}">
                                        <h4>Full Stack Web Dev</h4>
                                    </div>

                                    <div class="item">
                                        <img src="{{ URL::to('frontend/assets/images/icons/icon-5.png')}}">
                                        <h4>Combo GD/Web</h4>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="course-item">
                                                <div class="course-item-img">
                                                    ...
                                                    @endif
                                                    <a href="">
                                                        <img src="{{ URL::to('backend/img/course/' . $batch->course->image )}}" alt="">
                                                    </a>
                                                ...
                                                <div class="course-summary box">
                                                    ...
                                                    <div class="course-summary-inner">
                                                        ...
                                                        <ul class="course-meta">
                                                            ...
                                                            <li>
                                                                <span>Classes: </span> 
                                                                <span class="blue-highlight">{{ $batch->course->total_lecture }}</span><br>
                                                                <span>Hours: </span> 
