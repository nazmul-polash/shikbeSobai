...
class BranchController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.pages.branch.manage', compact('branchs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        [
            'name.required'     => 'Branch Name is empty',
    ...
    public function update(Request $request, $id)
    {
        ...
        $branch->save();
        return redirect()->route('branch.manage')->with('info','Branch Update Successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        {
            $branch->delete();
           return redirect()->route('branch.manage')->with('danger','Delete The Branch ');
        }
        else
        {
            return redirect()->route('branch.manage');
