...
class CourseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $course->course_oppertunity         =$request->course_oppertunity;
        ...
        $course->save();
        return redirect()->route('course.manage')->with('success','New Course Added Successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $course->save();
        return redirect()->route('course.manage')->with('info','Course Update Successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        $course->delete();
        return redirect()->route('course.manage')->with('danger','Delete The Course ');
    }
}
